...
function set_squire_variables() {
  ...
  export SQUIRE_CONFIG SQUIRE_DATA SQUIRE_CACHE SQUIRE_CACHE_BIN SQUIRE_CACHE_LIB SQUIRE_CACHE_AWK SQUIRE_EXTERNAL_LIBRARIES_DIR SQUIRE_TEMP_DIR_ROOT
}

function set_system_path_variables() {
  PATH="${SQUIRE_CACHE_BIN}:${PATH}"
  # This is the primary search path for modules
  SQUIRE_LIB_PATH="${SQUIRE_CACHE_LIB}:${SQUIRE_LIB_PATH}"
